...
public class PS6Q1
{
    ...
    public static void main(String[] args)
    {
        ...
        ArrayList<Clause> clausesOne = readClausesFromFile("C:\\Users\\piush\\Desktop\\sat1.txt");

        if(processTwoSAT(clausesOne)){
            System.out.println("C:\\Users\\piush\\Desktop\\sat1.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\sat1.txt => No Satisfiable (0)");
        }

        //Process second instance
        System.out.println("*** Processing second instance...");
        ArrayList<Clause> clausesTwo = readClausesFromFile("C:\\Users\\piush\\Desktop\\2sat2.txt");

        if(processTwoSAT(clausesTwo)){
            System.out.println("C:\\Users\\piush\\Desktop\\2sat2.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\2sat2.txt => No Satisfiable (0)");
        }

        //Process third instance
        System.out.println("*** Processing third instance...");
        ArrayList<Clause> clausesThree = readClausesFromFile("C:\\Users\\piush\\Desktop\\2sat3.txt");

        if(processTwoSAT(clausesThree)){
            System.out.println("C:\\Users\\piush\\Desktop\\2sat3.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\2sat3.txt => No Satisfiable (0)");
        }

        //Process fourth instance
        System.out.println("*** Processing fourth instance...");
        ArrayList<Clause> clausesFour = readClausesFromFile("C:\\Users\\piush\\Desktop\\2sat4.txt");

        if(processTwoSAT(clausesFour)){
            System.out.println("C:\\Users\\piush\\Desktop\\2sat4.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\2sat4.txt => No Satisfiable (0)");
        }

        //Process fifth instance
        System.out.println("*** Processing fifth instance...");
        ArrayList<Clause> clausesFive = readClausesFromFile("C:\\Users\\piush\\Desktop\\2sat5.txt");

        if(processTwoSAT(clausesFive)){
            System.out.println("C:\\Users\\piush\\Desktop\\2sat5.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\2sat5.txt => No Satisfiable (0)");
        }

        //Process sixth instance
        System.out.println("*** Processing sixth instance...");
        ArrayList<Clause> clausesSix = readClausesFromFile("C:\\Users\\piush\\Desktop\\2sat6.txt");

        if(processTwoSAT(clausesSix)){
            System.out.println("C:\\Users\\piush\\Desktop\\2sat6.txt => Satisfiable (1)");
        }
        else{
            System.out.println("C:\\Users\\piush\\Desktop\\2sat6.txt => No Satisfiable (0)");
        }
    }
