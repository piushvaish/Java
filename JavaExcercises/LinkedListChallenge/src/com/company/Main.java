...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Stormbringer", 4.22);
        ...
        album.addSong("Knight of the long knives", 5.12);
        ...
        albums.get(0).addToPlaylist("Speed King", playList);//doesnot exist
        ...
        albums.get(1).addToPlayList(25, playList);//There is no track
    ...
    private static void printMenu() {
        ...
        System.out.println("0 - to quit\n" +
                ...
                "6 - to remove current track from a playlist");
    }
}
