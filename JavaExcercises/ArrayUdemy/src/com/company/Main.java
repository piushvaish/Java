...
//        int[] sorted = sortedInteger(myIntegers);
//        printArray(sorted);
    ...
    public static void addItem(){
        System.out.print("Please enetr the grocery item: ");
        groceryList.addGrocery(in.nextLine());
    }
...
//        }
//    }
//    public static int [] sortedInteger(int [] values) {
